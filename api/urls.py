...
from api.views import home, UserLogin, PartnerRudView, ProcessRudView, ProcessCreateAPIView, ProcessListAPIView, PaymentAPIView, \
    PaymentRudView, ActionCreateAPIView, ActionRudView, ContractRudView, ContractAPIView, DayRudView, DayAPIView, \
    DiaryAPIView, DiaryRudView, NegotiationRudView, NegotiationAPIView, TariffAPIView, TariffRudView, MediaPlanAPIView, \
    MediaPlanRudView, SettingsAPIView, SettingsRudView, PartnerListAPIView, PartnerCreateAPIView, ActionListAPIView
